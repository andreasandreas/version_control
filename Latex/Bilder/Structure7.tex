\tikzset{
	A0/.pic={
        code={
\draw[black](0,0)node[rotate=00]{\small \texttt{miscallaneous}};
\draw[black](0,-0.5)node[rotate=00]{\tiny \texttt{files and directories.}};
\draw[black](0,-0.9)node[rotate=00]{\tiny \texttt{created by}};
\draw[black](0,-1.3)node[rotate=00]{\tiny \texttt{cmake}};
...
\draw[black](0,-0.9)node[rotate=00]{\tiny \texttt{CMakeLists.txt}};
%\draw[black](0,-1.3)node[rotate=00]{\tiny \texttt{}};
						}
	}
}
...
\tikzset{
	D/.pic={
		code={
			...
			\draw[black](0,-0.5)node[rotate=00]{\tiny \texttt{.so-files}};
			\draw[black](0,-0.9)node[rotate=00]{\tiny \texttt{.a-files}};
			%\draw[black](0,-1.3)node[rotate=00]{\tiny \texttt{...}};
			}
	}
}
...
\draw [black,->] (0,3.3)--(-6.25,2.2);
\draw [black,->] (0,3.3)--(-3.75,2.2);
\draw [black,->] (0,3.3)--(-1.25,2.2);
\draw [black,->] (0,3.3)--(1.25,2.2);
\draw [black,->] (0,3.3)--(3.75,2.2);
\draw [black,dashed,->] (0,3.3)--(6.25,2.2);
\end{tikzpicture}
