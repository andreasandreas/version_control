...
\draw[black](0,-0.5)node[rotate=00]{\small \texttt{...}};
\draw[black](0,-0.9)node[rotate=00]{\small \texttt{...}};
...
\draw[black](0,-0.5)node[rotate=00]{\small \texttt{binaries}};
\draw[black](0,-0.9)node[rotate=00]{\small \texttt{executable}};
\draw[black](0,-1.3)node[rotate=00]{\small \texttt{...}};
%\draw[black,thick](-0.5,-0.15)rectangle(0.5,0.15);   
							}
	}
...
\draw[black](0,-0.9)node[rotate=00]{\small \texttt{additional}};
\draw[black](0,-1.3)node[rotate=00]{\small \texttt{CMakeLists.txt}};
						}
	}
}
...
\draw[black](0,-0.5)node[rotate=00]{\small \texttt{.hpp-files:}};
\draw[black](0,-0.9)node[rotate=00]{\small \texttt{...}};
\draw[black](0,-1.3)node[rotate=00]{\small \texttt{...}};
							}
	}
...
\draw [black,->] (0,3.3)--(-6,2.2);
\draw [black,->] (0,3.3)--(-3,2.2);
